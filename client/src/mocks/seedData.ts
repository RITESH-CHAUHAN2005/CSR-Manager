...
export const projects: Project[] = [
  {
    ...
    companyIds: ['c3'],
    commitments: [{ companyId: 'c3', committedAmount: 2500000 }],
    derivedStatus: 'other',
  ...
  },
  {
    ...
    companyIds: ['c3'],
    commitments: [{ companyId: 'c3', committedAmount: 3500000 }],
    derivedStatus: 'other',
  ...
  },
  {
    ...
    companyIds: ['c3'],
    commitments: [{ companyId: 'c3', committedAmount: 4000000 }],
  ...
  },
  {
    ...
    companyIds: ['c2'],
    commitments: [{ companyId: 'c2', committedAmount: 1800000 }],
    derivedStatus: 'other',
  ...
  },
  {
    ...
    companyIds: ['c2'],
    commitments: [{ companyId: 'c2', committedAmount: 2200000 }],
    derivedStatus: 'ongoing',
  ...
  },
  {
    ...
    companyIds: ['c1'],
    commitments: [{ companyId: 'c1', committedAmount: 1000000 }],
    derivedStatus: 'other',
  ...
  },
  {
    ...
    companyIds: ['c1'],
    commitments: [{ companyId: 'c1', committedAmount: 2000000 }],
    derivedStatus: 'ongoing',
