...
export async function seedDatabase() {
  ...
  const [hdfc, infosys, tcs] = await Company.create([
    { name: 'HDFC Bank CSR Trust', cin: 'U65920MH1994PLC080618', pan: 'AAACH2702H', contactPerson: 'Nandita Taneja', email: 'csrtrust@hdfc.com', phone: '+91-22-66521000', address: 'HDFC Bank House, Senapati Bapat Marg, Lower Parel, Mumbai - 400013', description: 'Long-standing CSR partner; focus on environment and elderly-care programmes.' },
    { name: 'Infosys Foundation', cin: 'U93090KA2013NPL068315', pan: 'AAAAI6743M', contactPerson: 'Sudha Murthy', email: 'foundation@infosys.com', phone: '+91-80-28520261', address: 'Infosys Foundation, Electronics City, Hosur Road, Bengaluru - 560100', description: 'Supports education scholarships and rural healthcare initiatives.' },
    { name: 'Tata Consultancy Services Ltd', cin: 'U72200MH2004PLC153930', pan: 'AAACT2727Q', contactPerson: 'Rajesh Kumar', email: 'csr@tcs.com', phone: '+91-22-67789999', address: 'TCS House, Raveline Street, Fort, Mumbai - 400001', description: 'Primary donor for digital-literacy and skill-development programmes.' },
  ])
  ...
  await Expenditure.create([
    { date: '2022-06-20', projectId: p1._id, companyId: tcs._id, financialYearId: fy1._id, approvedBy: 'Trustee Board', amount: 800000, description: 'Setting up village learning centres' },
    { date: '2022-09-15', projectId: p1._id, companyId: tcs._id, financialYearId: fy1._id, approvedBy: 'Executive Director', amount: 950000, description: 'Trainer fees and course material' },
    { date: '2023-01-20', projectId: p1._id, companyId: tcs._id, financialYearId: fy1._id, approvedBy: 'Trustee Board', amount: 500000, description: 'Computer lab for the Pune centre — 25 desktops and networking equipment' },
    { date: '2023-07-20', projectId: p2._id, companyId: tcs._id, financialYearId: fy2._id, approvedBy: 'Trustee Board', amount: 1200000, description: '10 reverse-osmosis water purification units' },
    { date: '2023-08-15', projectId: p4._id, companyId: infosys._id, financialYearId: fy2._id, approvedBy: 'Trustee Board', amount: 1600000, description: 'Scholarship disbursal to 320 students' },
    { date: '2023-09-01', projectId: p6._id, companyId: hdfc._id, financialYearId: fy2._id, approvedBy: 'Trustee Board', amount: 750000, description: 'Saplings, plantation labour and 1-year upkeep' },
    { date: '2023-11-10', projectId: p2._id, companyId: tcs._id, financialYearId: fy2._id, approvedBy: 'Executive Director', amount: 1800000, description: 'Pipeline laying and village distribution points' },
    { date: '2024-01-15', projectId: p2._id, companyId: tcs._id, financialYearId: fy2._id, approvedBy: 'Executive Director', amount: 220000, description: 'Programme administration for the year' },
    { date: '2024-05-30', projectId: p3._id, companyId: tcs._id, financialYearId: fy3._id, approvedBy: 'Trustee Board', amount: 900000, description: 'Tailoring and food-processing skill batches' },
    { date: '2024-07-12', projectId: p3._id, companyId: tcs._id, financialYearId: fy3._id, approvedBy: 'Executive Director', amount: 650000, description: 'Independent impact assessment of batch 1' },
    { date: '2024-08-22', projectId: p5._id, companyId: infosys._id, financialYearId: fy3._id, approvedBy: 'Trustee Board', amount: 730000, description: 'Mobile medical van with diagnostic equipment' },
    { date: '2024-09-18', projectId: p5._id, companyId: infosys._id, financialYearId: fy3._id, approvedBy: 'Executive Director', amount: 500000, description: 'Medicines and camp staffing' },
    { date: '2024-10-05', projectId: p7._id, companyId: hdfc._id, financialYearId: fy3._id, approvedBy: 'Trustee Board', amount: 1000000, description: 'Day-care wing construction — 12-bed senior citizen facility' },
    { date: '2024-11-28', projectId: p7._id, companyId: hdfc._id, financialYearId: fy3._id, approvedBy: 'Trustee Board', amount: 700000, description: 'Beds, seating and kitchen fit-out' },
  ])
